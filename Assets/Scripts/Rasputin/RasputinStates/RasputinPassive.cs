...
public class RasputinPassive : State
{
    //How he acts when passive
    public RasputinPassive(CharacterTemplate owner, string name) : base(owner, name) { }
    ...
    public override int UseAbility()
    {
        ...
        int[] abilityOptions = new int[] { 0, 1, 1, 2, 4 };
