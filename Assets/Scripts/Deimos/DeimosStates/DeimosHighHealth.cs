...
public class DeimosHighHealth : HealthStateTemplate
{
    public DeimosHighHealth(CharacterTemplate owner, string name, State[] childStates) : base(owner, name, childStates) { }

        //the max damage Deimos can take before being defensive
            //35 - 30 - 20
    readonly float damageThreshold = 35;
